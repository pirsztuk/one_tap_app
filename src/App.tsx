        ...
        <DialogContent className="bg-white">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-600">
              Your payment of {formatPrice(price)} has been processed successfully.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button onClick={() => setShowConfirmation(false)} className="bg-black text-white hover:bg-gray-800">
              Close
            </Button>
          </DialogFooter>
        </DialogContent>
